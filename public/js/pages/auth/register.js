...
var KTWizard2 = function () {
    ...
    _wizard.on('beforeNext', function (wizard) {
      ...
      switch (_wizard.getStep()) {
        ...
        case 2:
          ...
          $('#UI_agree').text("You have".concat($('input[name=agree]:checked') ? ' ' : ' NOT ', "accepted the terms and conditions."));
          break;
      }
  ...
  var handleAuthRegisterFormSubmit = function handleAuthRegisterFormSubmit() {
    ...
    submitButton.click(function (e) {
      ...
      axios.post(registerForm.data('action'), formData).then(function (response) {
