...
// Keenthemes' plugins
window.KTUtil = __webpack_require__("Jjix");
window.KTApp = __webpack_require__("645V");
window.KTCard = __webpack_require__("Hnfm");
window.KTCookie = __webpack_require__("GaIe");
window.KTDialog = __webpack_require__("xGnY");
window.KTHeader = __webpack_require__("35z4");
window.KTImageInput = __webpack_require__("lc+j");
window.KTMenu = __webpack_require__("HmUd");
window.KTOffcanvas = __webpack_require__("9nkV");
window.KTScrolltop = __webpack_require__("F+DL");
window.KTToggle = __webpack_require__("OCu8");
window.KTWizard = __webpack_require__("SdBs");

__webpack_require__("Du8E");

__webpack_require__("VGjM");

__webpack_require__("xaGx"); // Metronic layout base js


window.KTLayoutAside = __webpack_require__("6xFD");
window.KTLayoutAsideMenu = __webpack_require__("jEdW");
window.KTLayoutAsideToggle = __webpack_require__("Bl2T");
window.KTLayoutBrand = __webpack_require__("XJl4X");
window.KTLayoutContent = __webpack_require__("pRxv");
window.KTLayoutFooter = __webpack_require__("SeWJ");
window.KTLayoutHeader = __webpack_require__("UoaL");
window.KTLayoutHeaderMenu = __webpack_require__("ZNuh");
window.KTLayoutHeaderTopbar = __webpack_require__("v+9O");
window.KTLayoutStickyCard = __webpack_require__("h6GK");
window.KTLayoutStretchedCard = __webpack_require__("7YI1");
window.KTLayoutSubheader = __webpack_require__("Oljl"); // Metronic layout extended js

window.KTLayoutChat = __webpack_require__("thjT");
window.KTLayoutDemoPanel = __webpack_require__("Bhsv");
window.KTLayoutExamples = __webpack_require__("dVI5");
window.KTLayoutQuickActions = __webpack_require__("cefM");
window.KTLayoutQuickCartPanel = __webpack_require__("3ACx");
window.KTLayoutQuickNotifications = __webpack_require__("OqOD");
window.KTLayoutQuickPanel = __webpack_require__("cIr0");
window.KTLayoutQuickSearch = __webpack_require__("HH6z");
window.KTLayoutQuickUser = __webpack_require__("gJo/");
