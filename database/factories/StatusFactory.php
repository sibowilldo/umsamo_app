...
$factory->define(Status::class, function (Faker $faker) {
    ...
    $statuses = [
        ...
        ['title' => 'Active', 'color' => 'success', 'model_type' => 'App\EventDate'],
        ['title' => 'Full', 'color' => 'danger', 'model_type' => 'App\EventDate'],
        ['title' => 'Unpublished', 'color' => 'light', 'model_type' => 'App\EventDate'],
        ...
        ['title' => 'Pending', 'color' => 'warning', 'model_type' => 'App\Appointment'],
