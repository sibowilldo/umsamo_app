...
<div class="topbar">
    ...
    {{-- Quick panel --}}
    @if (config('header.topbar.quick-panel.display'))
        <div class="topbar-item">
            ...
            <div class="topbar-item">
                <div class="btn btn-icon w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
                    <span class="text-muted font-weight-bold font-size-base d-none d-md-inline mr-1">Hi,</span>
                        <span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3">{{ Auth::user()->profile->first_name }}</span>
                            <span class="symbol symbol-35 symbol-light-success">
                        <span class="symbol-label font-size-h5 font-weight-bold">{{ Str::substr(Auth::user()->profile->first_name, 0, 1) }}</span>
                    </span>
                </div>
            </div>
        @else
