    ...
    <div class="row">
        <div class="col-lg-8 offset-lg-2">
            <div class="card card-custom">
                <div class="card-header">
                    ...
                    <div class="card-toolbar">
                        <div class="justify-content-center">
                            <a href="{{ route('regions.index') }}" class="btn btn-primary font-weight-bolder">
                ...
                {{ Form::model($region, ['route' =>['regions.update', $region->id],
                                        'id' => 'regionEditForm',
                                        'class' => 'form',
                                        'data-action' => route('regions.update', $region->id),
                                        'method' => 'patch']) }}

                    <div class="card-body">
                        @include('backend.region._form')
                    </div>
                    <div class="card-footer bg-gray-100 border-top-0 text-right rounded-bottom">
                        <div class="row">
                            <div class="col-lg-9 ml-lg-auto">
                                <button id="submitForm" type="submit" class="btn btn-primary font-weight-bold mr-2">Update Region</button>
...
@section('scripts')
    <script src="{{ asset('js/pages/backend/region/edit.js') }}" type="text/javascript" defer></script>
@endsection
