    ...
    <div class="row">
        <div class="col-lg-8 offset-lg-2">
            <div class="card card-custom">
                ...
                <form method="post" class="form" id="regionCreateForm" data-action="{{route('regions.store')}}">
                    <div class="card-body">
                    ...
                    <div class="card-footer bg-gray-100 border-top-0 text-right rounded-bottom">
                        <div class="row">
                            <div class="col-lg-9 ml-lg-auto">
                                <button id="submitForm" type="submit" class="btn btn-primary font-weight-bold mr-2">Save Region</button>
...
@section('scripts')
    <script src="{{ asset('js/pages/backend/region/create.js') }}" type="text/javascript" defer></script>
@endsection
