            ...
            <div class="mt-lg-10 pb-15">
                    ...
                    @else
                        <div class="alert alert-danger">
                            <span class="font-weight-bold text-white"><strong>STOP:</strong> This account is locked by its owner, <br>and can only be unlocked with a special link that was sent to them.</span>
                        </div>
                    @endif
            </div>
