...
<div class="card card-custom {{ @$class }}">
    ...
    <div class="card-body">
        <div class="tab-content">
            <div class="tab-pane fade show active" id="upcoming_appointments_tab" role="tabpanel"
                 aria-labelledby="upcoming_appointments_tab">
                            ...
                            <tr>
                                <td class="pl-3 py-8">
                                    <div class="d-flex align-items-center">
                                        <span
                                            class="bullet bullet-bar bg-{{ $appointment->status->color }} align-self-stretch pb-10 mr-4"> </span>
                                        <div>
                                            <a href="#"
                                               class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">{{ $appointment->event_date->date_time->format('D M d, Y') }}</a>
                                            <span
                                                class="text-muted font-weight-bold d-block">{{ $appointment->event_date->date_time->diffForHumans() }}</span>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                ...
                                <td>
                                    <span
                                        class="text-muted font-weight-bold">{{ $appointment_types->where('id', $appointment->type )->first()['title']}}</span>
                                </td>
                                <td>
                                    <span
                                        class="text-muted font-weight-bold">{{ $appointment->created_at->diffForHumans() }}</span>
                                </td>
                                            ...
                                            <div class="d-flex min-h-350px align-items-center p-5">
                                                ...
                                                <div class="d-flex flex-column">
                                                    ...
                                                    <div class="text-muted">
                                                        ...
                                                        <br> If you think this is in error, please contact us so we can
                                                        investigate
            ...
            <div class="tab-pane fade" id="family_upcoming_appointments_tab" role="tabpanel"
                 aria-labelledby="family_upcoming_appointments_tab">
                <!--begin::Table-->
                <div class="table-responsive">
                    <table class="table table-head-custom table-head-bg table-borderless table-vertical-center">
                        <thead>
                            ...
                            <tr>
                                <td class="pl-3 py-8">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <a href="#"
                                               class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">{{ $appointment->appointment->event_date->date_time->format('D M d, Y') }}</a>
                                            <span
                                                class="text-muted font-weight-bold d-block">{{ $appointment->appointment->event_date->date_time->diffForHumans() }}</span>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                ...
                                <td>
                                    <span
                                        class="text-muted font-weight-bold">{{ $appointment_types->where('id', $appointment->appointment->type )->first()['title']}}</span>
                                </td>
                                <td>
                                    <span
                                        class="text-muted font-weight-bold">{{ $appointment->created_at->diffForHumans() }}</span>
                                ...
                                <td class="pr-0 text-right">
                                    <div class="d-flex align-items-center justify-content-end"
                                         aria-label="View Details">
                                        <a href="{{ route('appointments.show', $appointment->appointment->uuid) }}"
                                           class="btn btn-light btn-icon btn-sm" data-toggle="tooltip"
                                           title="View Details">
                                            {{ Metronic::getSVG('media/svg/icons/Navigation/Arrow-right.svg', 'svg-icon svg-icon-md svg-icon-primary') }}
                                        </a>
